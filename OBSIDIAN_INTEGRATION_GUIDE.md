...
A comprehensive step-by-step guide for using the Obsidian integration features in TaskMaster, based on real-world testing with an Obsidian vault.
...
```bash
node index.js obsidian-init "C:\path\to\your\obsidian\vault"
```

**Example:**
```bash
node index.js obsidian-init "C:\Users\User\Desktop\Testing\vault-main"
```
...
```bash
node index.js obsidian-sync --to-obsidian --vault-path "C:\path\to\your\vault" --dry-run
```
...
```bash
node index.js obsidian-sync --to-obsidian --vault-path "C:\path\to\your\vault"
```
...
```bash
node index.js obsidian-sync --from-obsidian --vault-path "C:\path\to\your\vault" --dry-run
```
...
```bash
node index.js obsidian-sync --from-obsidian --vault-path "C:\path\to\your\vault"
```
...
```bash
node index.js obsidian-sync --bidirectional --vault-path "C:\path\to\your\vault" --dry-run
```
...
```bash
node index.js obsidian-sync --bidirectional --vault-path "C:\path\to\your\vault"
```
...
```bash
node index.js obsidian-status --vault-path "C:\path\to\your\vault"
```
...
node index.js obsidian-init "vault-path"

# Sync TaskMaster → Obsidian (preview)
node index.js obsidian-sync --to-obsidian --vault-path "vault-path" --dry-run

# Sync TaskMaster → Obsidian (execute)
node index.js obsidian-sync --to-obsidian --vault-path "vault-path"

# Sync Obsidian → TaskMaster (preview)
node index.js obsidian-sync --from-obsidian --vault-path "vault-path" --dry-run

# Sync Obsidian → TaskMaster (execute)
node index.js obsidian-sync --from-obsidian --vault-path "vault-path"

# Bidirectional sync (preview)
node index.js obsidian-sync --bidirectional --vault-path "vault-path" --dry-run

# Bidirectional sync (execute)
node index.js obsidian-sync --bidirectional --vault-path "vault-path"

# Check sync status
node index.js obsidian-status --vault-path "vault-path"
```

## Example Complete Workflow

1. **Setup:** `node index.js obsidian-init "C:\Users\User\Desktop\Testing\vault-main"`
2. **Initial sync:** `node index.js obsidian-sync --to-obsidian --vault-path "C:\Users\User\Desktop\Testing\vault-main" --dry-run`
3. **Execute sync:** `node index.js obsidian-sync --to-obsidian --vault-path "C:\Users\User\Desktop\Testing\vault-main"`
4. **Make edits in Obsidian:** Edit task files manually
5. **Preview import:** `node index.js obsidian-sync --from-obsidian --vault-path "C:\Users\User\Desktop\Testing\vault-main" --dry-run`
6. **Import changes:** `node index.js obsidian-sync --from-obsidian --vault-path "C:\Users\User\Desktop\Testing\vault-main"`
7. **Check status:** `node index.js obsidian-status --vault-path "C:\Users\User\Desktop\Testing\vault-main"`
